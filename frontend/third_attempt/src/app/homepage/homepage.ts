...
type LanguageId = 'english' | 'japanese' | 'cantonese';
...
export class Homepage implements AfterViewInit, OnDestroy {
  ...
  readonly introLanguages: IntroLanguage[] = [
  ...
  readonly nightfallBeats: ShrineBeat[] = [
    {
      speaker: 'Narration',
      text:
    ...
    },
    {
      speaker: 'Narration',
      text:
        'Jolie stayed behind. Not far. Just enough to let the others move ahead without her.',
    },
    {
      speaker: 'Narration',
      text:
        'The words from the shrine had followed her all the way through the trees. A group project. An Instagram message. A sentence she had written without thinking much of it.',
    },
    {
    ...
    },
    {
      speaker: 'Narration',
      text:
        'For a while, Jolie stayed where she was. The forest became quiet around her. Not empty. Just quiet enough for every thought to sound louder.',
    },
    {
      speaker: 'Narration',
      text:
        'She turned away from the path back to town and walked deeper beneath the trees. The ground was uneven, covered with roots, fallen leaves, and old stones hidden beneath the grass.',
    },
    {
      speaker: 'Narration',
      text:
        'Above her, the branches twisted together, blocking most of the moonlight. She did not know exactly where she was going. She only knew she was not ready to return yet.',
    },
    {
      speaker: 'Narration',
      text:
    ...
    },
    {
      speaker: 'Narration',
      text:
        'Jolie gathered a few dry branches, made a small fire, and sat close enough to feel its warmth against the cold night air. Then she opened her books.',
    },
    {
      speaker: 'Narration',
      text:
    ...
    },
    {
      speaker: 'Narration',
      text:
        'Her eyes moved across the page, yet her mind kept returning to the shrine. A group project. An Instagram message. A playful sentence.',
    },
    {
      speaker: "Jolie's inner thought",
    ...
    },
    {
      speaker: 'Narration',
      text:
        'Back then, it had felt simple. Too simple to matter. Just a message sent to make things easier.',
    },
    {
      speaker: 'Narration',
      text:
        'Maybe to make the first meeting less awkward. Maybe because being playful felt safer than being too formal.',
    },
    {
      speaker: 'Narration',
      text:
    ...
    },
    {
      speaker: 'Narration',
      text:
        'The fire cracked softly beside her. The forest around her stayed still.',
    },
    {
      speaker: 'Narration',
      text:
    ...
    },
    {
      speaker: 'Narration',
      text:
        'She stared at the fire. Its warmth reached her hands, but not the strange feeling in her chest.',
    },
    {
      speaker: "Jolie's inner thought",
    ...
    },
    {
      speaker: 'Narration',
      text:
        'That thought made her feel quiet. Not guilty exactly. But careful. As if the past had become a fragile object in her hands.',
    },
    {
      speaker: 'Narration',
      text:
        'The shrine had not shown her a grand confession. It had not shown a dramatic promise. It had not shown a goodbye under rain or anything that would obviously belong in a story.',
    },
    {
      speaker: 'Narration',
      text:
        'It had shown a beginning so ordinary that she almost missed the weight of it. And somehow, that made it harder to ignore.',
    },
    {
      speaker: "Jolie's inner thought",
    ...
    },
    {
      speaker: 'Narration',
      text:
        'The fire shifted. A small spark rose, then disappeared into the dark.',
    },
    {
      speaker: 'Narration',
      text:
        'Jolie closed the book halfway, keeping one finger between the pages. She looked into the forest.',
    },
    {
      speaker: 'Narration',
      text:
        'Somewhere beyond the trees, Eldermere was waiting. Fern was probably already annoyed. The old lady was probably pretending not to worry. But Jolie did not move yet.',
    },
    {
      speaker: 'Narration',
      text:
        'For the first time since entering Eldermere, she felt that the town was not only showing his memories. It was asking her to remember too.',
    },
    {
      speaker: "Jolie's inner thought",
    ...
    },
    {
      speaker: 'Narration',
      text:
        'The night gave no answer. Only the fire stayed with her, small and warm beneath the old tree, while the question remained open on the page.',
    },
  ];

  private readonly translatedText: Record<LanguageId, Record<string, string>> = {
    english: {},
    japanese: {
      Prologue: 'プロローグ',
      English: '英語',
  ...
  translateText(text?: string): string {
    ...
    return this.translatedText[this.selectedIntroLanguage][text] ?? text;
  }
